...
if($conn){
$query="SELECT * FROM admin_info WHERE username='$search' OR email='$search' ";
...
<!--Table head-->
  ...
  <?php $_SESSION['keyofadmin']=true;?>
    <tr>
      ...
      <td class="search"><?php echo $rows['username']; ?></td>
...
<script>
  ...
  $('#back').click(function(){
  document.location.replace('http://127.0.0.1/myproject/admin/adminsinfo.php');
  });
  });
</script>
<?php
