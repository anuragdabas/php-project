...
<hr>
<br>
<p>Want to change Password?<a href="http://127.0.0.1/myproject/admin/adminresetpass.php" >Click here</a></p>
<br />
</form>
</div>
</div>
...
if(isset($_POST['submit'])){
  ...
  $conn=mysqli_connect('localhost','root','','myform');
  if($conn){
  $query="UPDATE admin_info SET username='$username',mobilenumber='$mobilenumber',gender='$gender' WHERE email='$email' ";
  $res=mysqli_query($conn,$query);
  if($res){
